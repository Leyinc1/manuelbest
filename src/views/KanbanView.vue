<template>
  <div class="kanban-view">
    ...
    <div v-if="store.currentProjectId" class="kanban-board">
      <KanbanColumn title="Por Hacer" statusId="todo" :tasks="store.tasksByStatus.todo" />
      <KanbanColumn
        title="En Progreso"
        statusId="in-progress"
        :tasks="store.tasksByStatus['in-progress']"
      />
      <KanbanColumn title="Hecho" statusId="done" :tasks="store.tasksByStatus.done" />
    </div>
