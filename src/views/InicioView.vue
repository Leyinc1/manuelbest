<template>
  <div class="kanban-view">
    <button id="tutorialBtn" @click="showTutorial = true">?</button>
    ...
    <div v-if="authStore.user">
      ...
      <div v-if="kanbanStore.currentProjectId" class="kanban-board">
      ...
      <div v-else class="no-projects">
        ...
        <p>No tienes proyectos. ¡Crea uno para empezar a organizar tus tareas!</p>
      </div>
    </div>
